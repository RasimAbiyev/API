...
urlpatterns = [
    ...
    path('api/', include('employees.urls')),  # Ensure this line points to employees.urls
    path('swagger/', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),  # Enable Swagger UI
